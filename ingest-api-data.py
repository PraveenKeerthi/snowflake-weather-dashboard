...
def snowpark_basic_auth():
    con = snowflake.connector.connect(
        user='PRAVEENKEERTHI',
        password='Praveen111101$',
        account='cpvunot-nib45448',
        database='dev_db',
        schema='stage_sch',
        warehouse='load_wh',
        role='SYSADMIN'
...
def get_air_quality_data(api_key, limit):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            sf_session.execute(f"PUT file://{file_name} {stg_location}")
            ...
            result_lst = sf_session.execute(lst_query).fetchall()
...
api_key = '579b464db66ec23bdd0000016a945a659d324b7c7cfcdb35fc4b8ef5'
